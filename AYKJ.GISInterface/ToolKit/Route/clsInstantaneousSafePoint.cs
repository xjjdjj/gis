...
namespace AYKJ.GISInterface
{
    ...
    /// <param name="e"></param>
    public delegate void InstantaneousSafePointDelegate(object sender, EventArgs e);

    public class clsInstantaneousSafePoint
    {
        //定义事件
        public event InstantaneousSafePointDelegate SafePointEvent;
        public event InstantaneousSafePointDelegate SafePointFaildEvent;
        //GeometryService
        ...
        void ProcessAction(object sender, EventArgs e)
        {
            if (SafePointEvent == null)
                SafePointEvent += new InstantaneousSafePointDelegate(SafePointErrorEvent);
        ...
        /// <param name="arealeak">避开区域</param>
        ...
        public void SafeRoute(Map tmpmap, MapPoint mprecipient, MapPoint mpleak, List<Graphic> arealeak, string strgurl, string strnurl, string strqurl, double dblen)
        {
            lstarea = arealeak;
            map = tmpmap;
            strgeourl = strgurl;
